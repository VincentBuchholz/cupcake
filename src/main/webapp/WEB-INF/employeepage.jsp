...
<div class="container">
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            <li class="nav-item">
                                <a class="nav-link active" href="${pageContext.request.contextPath}/fc/employeepage">Home</a>
                            </li>
                            <li class="nav-item">
    ...
    <div class="content">
        <div class="jumbotron bg-light mt-5 p-5 shadow-lg p-3 mb-5 bg-white rounded">
            ...
            <p class="lead">This is the administrator page,</br>you can see all the customers and orders in here</p>
        </div>
    </div>
</div>
